...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { content: @faq.content, efective: @faq.efective, title: @faq.title, visible: @faq.visible }
    end
  ...
  test "should update faq" do
    patch :update, id: @faq, faq: { content: @faq.content, efective: @faq.efective, title: @faq.title, visible: @faq.visible }
    assert_redirected_to faq_path(assigns(:faq))
  end
